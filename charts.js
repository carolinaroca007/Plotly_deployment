...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var filteredSample = sampleData.filter(item => item.id == sample);
    ...
    var yticks = otuID.slice(0,10).map(item => "OTU " + item).reverse();
    var xticks = sampleValue.splice(0, 10).reverse();
    console.log(yticks)
